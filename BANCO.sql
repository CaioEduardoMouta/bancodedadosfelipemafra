...
/*MODELAGEM CONCEITUAL - RASCUNHO
MODELAGEM LÓGICA - FAZ O DIAGRAMA DE CLASSSES
MODELAGEM LÓGICA - PROGRAMAS COMO BRMODELO */

/* FASE 03 - DBA / AD */
/*MODELAGEM FÍSICA - QUANDO É PASSADO PARA UMA SGBD
...
/*  COMO É A ESTRUTURA DE UMA TABELA */
/* DESCREVENDO TABELAS */
DESC CLIENTE;

/* TIPAGEM DE TABELAS DE BANCO DE DADOS 
IMAGENS BLOB 
PALAVRAS CHAR E VARCHAR 
NUMEROS INTEIROS E QUEBRADOS FLOAT E INT 
EXEMPLO FLOAT (TOTAL, VIRGULA) NUMERO QUE VAI SER PASSADO E QUANTOS
APÓS O PONTO E INT SÓ ACEITA NUMEROS INTEIROS 
PARA TEXTOS GRANDES TEXT 
*/
...
('JOAO','M','JOAO@GMAIL.COM',992192121,'22923110','MAIA LACERDA - CENTRO - RIO DE JANEIRO - RJ' );

INSERT INTO CLIENTE VALUES
('PEDRO','M','JEDO@GMAIL.COM',832192121,'44923110','PELE - BARRA DA TIJUCA - RIO DE JANEIRO - RJ' );

INSERT INTO CLIENTE VALUES
('JOSEVALDO','M','JOSEVALDO@GMAIL.COM',212192121,'21923110','ANTONIO FRANCISCO - FLAMENGO - RIO DE JANEIRO - RJ' );

/* FORMA 02 - COLOCANDO AS COLUNAS */
INSERT INTO CLIENTE (NOME,SEXO,CPF,TELEFONE,ENDERECO) VALUES
('LILIAN','F',482192121,'44423110','PELE - COPACANABA - RIO DE JANEIRO - RJ' );

/*FORMA 03 - INSERT COMPACTO - SOMENTE MYSQL */

INSERT INTO CLIENTE VALUES('ANA','F','ANA@GLOBO.COM',85548962,'548556985','PRES ANTONIO CENTRO GOVERNADOR VALADARES-MG'),
					('PAMELA','F','PAM@GLOBO.COM',21248962,'898782985','PRES ANTONIO CENTRO BALNEARIO CAMBURIU-MG');
...
/* ULTILIZANDO O LIKE */
/* LIKE É ULTILIZADO PARA ACHAR UMA PARTE ESPECIFICA DO CAMPO */
/* % SE COLOCAR NO COMEÇO É QUANDO TERMINA  SE COLOCAR ENTRE 
A PARTE QUE DIZER QUE ESTÁ NO CAMPO EX %CENTRO% USAR LIKE 
DE VEZ EM QUANDO*/
...
SELECT NOME, SEXO, ENDERECO FROM CLIENTE
WHERE ENDERECO LIKE 'ANTONIO FRANCISCO%';
...
SELECT LIVRO , UF FROM LIVRO WHERE SEXO = 'M';
...
INSERT INTO LIVRO VALUES('JAVA DEITEL','DEITEL','M',485,'JAVA',249.9,'SP',2019);
INSERT INTO LIVRO VALUES('LIDERANÇA JAVA','ERNESTO','M',265,'CASA DE CÓDIGO',49.9,'RS',2012);
INSERT INTO LIVRO VALUES('PRODUCT OWNER','PAULA CLAUDIA','F',465,'ATLAS',49.9,'RJ',2009);
INSERT INTO LIVRO VALUES('BIG DATA','CAIO MOUTA','M',465,'ATLAS',49.9,'RJ',2009);
INSERT INTO LIVRO VALUES('BUSSINESS INTELIGENCE','LANDERLAN','M',465,'ATLAS',49.9,'RJ',2009);
INSERT INTO LIVRO VALUES('MACHINE LEARNING','MAX VERSTAPPEN','M',465,'ATLAS',49.9,'RJ',2009);

/* SABER ONDE ESTÁ CONECTADO */
STATUS

/* MOSTRAR QUANTOS BANCOS FORAM CRIADOS */
...
/* TRAZER NOME DO LIVRO E O NOME DA EDITORA */
...
/* TRAZER O NOME DO LIVRO E O NÚMERO DE PÁGINAS DOS LIVROS PUBLICANOS POR AUTORES DO SEXO FEMININO */
SELECT LIVRO,PAGINAS,SEXO FROM LIVRO WHERE SEXO = 'F';

/* TRAZER OS VALORES DOS LIVROS DAS EDITORAS DE SÃO PAULO */
SELECT VALOR FROM LIVRO WHERE UF = 'SP';

/* TRAZER OS VALORES DOS AUTORES DO SEXO MASCULINO QUE TIVERAM LIVROS PUBLICADOS POR SÃO PAULO OU RIO DE JANEIRO */
SELECT AUTOR,SEXO, UF  FROM LIVRO WHERE SEXO = 'M' AND  (UF = 'SP' OR UF = 'RJ');

/* OPERADORES LÓGICOS 
OR-> BASTA QUE UMA SEJA VERDADEIRA PARA QUE SEJA VERDADEIRA */

SELECT NOME, SEXO, ENDERECO FROM CLIENTE 
WHERE SEXO = 'M' OR ENDERECO LIKE '%RJ';

SELECT NOME, SEXO , ENDERECO FROM CLIENTE WHERE SEXO = 'F' OR ENDERECO LIKE '%PRES ANTONIO';

/* AND QUANDO AMBAS SÃO VERDADEIRAS */

SELECT NOME, SEXO, ENDERECO FROM CLIENTE WHERE SEXO = 'M' AND ENDERECO LIKE '%RJ';

SELECT NOME, SEXO , ENDERECO FROM CLIENTE WHERE SEXO = 'F' AND ENDERECO LIKE '%PRES ANTONIO';
...
SELECT COUNT(*) FROM FUNCTIONARIOS;
...
SELECT NOME, SEXO FROM FUNCIONARIOS WHERE (DEPARTAMENTO = 'LAR' AND SEXO = 'FEMININO') OR (DEPARTAMENTO = 'FILMES' AND SEXO = 'FEMININO');

SELECT * FROM FUNCIONARIOS WHERE SEXO = 'MASCULINO' OR DEPARTAMENTO = 'Jardim';

/* QUE NÃO TEM EMAIL */
SELECT EMAIL FROM CLIENTE WHERE EMAIL IS NULL;
...
UPDATE CLIENTE SET = "CAIO.DEV.MOUTA@GMMAIL.COM";

/* WHERE VAI SER O SEU MELHOR AMIGO PARA VIDA INTEIRA */
/* ALTERANDO */

SELECT * FROM CLIENTE WHERE  NOME = "LILIAN";

UPDATE CLIENTE 
SET EMAIL = 'JOAOLIMA@IGCOM.BR'
WHERE NOME = 'JOAO';

UPDATE CLIENTE 
SET EMAIL = 'PEDRINHO13@GMAIL.COM.BR'
WHERE NOME = 'PEDRO';

UPDATE CLIENTE 
SET EMAIL = 'LILIANGATINHA@GMAIL.COM.BR'
WHERE NOME = 'LILIAN';

UPDATE CLIENTE 
SET EMAIL = 'JEDO@GMAIL.COM.BR'
WHERE NOME = 'JOSEVALDO';

/*DELETANDO REGISTROS - NUNCA USE SEM WHERE */
...
INSERT INTO CLIENTE VALUES('CARLA','F','LILIAN@HOTMAIL.COM',999031232,'8832-3221','RUA CAIO MOUTA 221 SANTINHO FLORIANOPOLIS-SC');
/* COMMIT E ROLBACK PARA VOLTAR */
...
/*
	...
	2 - TODO CAMPO MULTIVALORADO SE TORNARA PUTRA TABELA
		QUANDO O CAMPO FOR DIVISIVEL 
		
	3 - TODA TABELA NECESSITA DE PELO MENOS UM CAMPO QUE INDENTIFIQUE
		TODO REGISTRO COMO SENDO UNICO 
...
/*NÃO A VIRGULA APÓS A ÚLTIMA COLUNA DA TABELA */
/* COLOCA UNIQUE NÃO SE REPETE */
...
TELEFONE - NÃO OBRIGATORIO CADASTRO DE MAIS DE UM (OPCIONAL) /*

/* CHAVE ESTRANGEIRA É A CHAVE PRIMARIA DE UMA TABELA QUE VAI ATÉ A
OUTRA TABELA PARA FAZER REFERÊNCIA ENTRE REGISTROS * /

/* EM RELACIONAMENTO 1 X 1 A CHAVE ESTRANGEIRA FICA NA TABELA MAIS FRACA */

/* EM RELACIONAMENTO 1 * n A CHAVE ESTRANGEIRA FICA DO LADO N */

/* CRIAR NO BANCO DE DADOS FOREIGN KEY */


/* INSERINDO NO BANCO DE DADOS */

INSERT INTO CLIENTE VALUES(NULL,'JOÃO','M','JOÃO@IG.COM','784994874');
INSERT INTO CLIENTE VALUES(NULL,'CARLOS','M','CARLOS@IG.COM','784994872');
INSERT INTO CLIENTE VALUES(NULL,'ANA','F','ANINHA@IG.COM','784994901');
INSERT INTO CLIENTE VALUES(NULL,'CLARA','F','CLARA@IG.COM','784994789');
INSERT INTO CLIENTE VALUES(NULL,'JORGE','M','JORGE@IG.COM','784994322');
INSERT INTO CLIENTE VALUES(NULL,'CELIA','F','CELIA@IG.COM','784994234');
INSERT INTO CLIENTE VALUES(NULL,'MAGNO','M','MAGNO@IG.COM','784994623');

+-----------+--------+------+---------------+-----------+
| IDCLIENTE | NOME   | SEXO | EMAIL         | CPF       |
+-----------+--------+------+---------------+-----------+
|         1 | JOÃO   | M    | JOÃO@IG.COM   | 784994284 |
|         2 | CARLOS | M    | CARLOS@IG.COM | 784994872 |
|         3 | ANA    | F    | ANINHA@IG.COM | 784994901 |
|         4 | CLARA  | F    | CLARA@IG.COM  | 784994789 |
|         5 | JORGE  | M    | JORGE@IG.COM  | 784994322 |
|         6 | CELIA  | F    | CELIA@IG.COM  | 784994234 |
|         7 | MAGNO  | M    | MAGNO@IG.COM  | 784994623 |
+-----------+--------+------+---------------+-----------+

INSERT INTO ENDERECO VALUES(NULL,'RUA ANTONIO SÁ','CENTRO','BELO HORIZONTE','MG',1);
INSERT INTO ENDERECO VALUES(NULL,'RUA IMPERADOR','FLAMENGO','RIO DE JANEIRO','RJ',2);
INSERT INTO ENDERECO VALUES(NULL,'RUA RPES VARGAS','BAIXADA SANTISTA','SANTOS','SP',3);
INSERT INTO ENDERECO VALUES(NULL,'RUA ALFANDEGA','CURUÇA','SÃO PAULO','SP',4);
INSERT INTO ENDERECO VALUES(NULL,'RUA DO OUVIDOR','CANAASVIEIRAS','FLOARIANOPOLIS','SC',5);
INSERT INTO ENDERECO VALUES(NULL,'RUA URUGUAIANA','JURERE INTERNACIONAL','PENHA','SC',6);

SELECT * FROM ENDERECO;

INSERT INTO TELEFONE VALUES(NULL,'CEL','4323-4212',1);
INSERT INTO TELEFONE VALUES(NULL,'COM','5323-4212',1);
INSERT INTO TELEFONE VALUES(NULL,'RES','6423-4212',2);
INSERT INTO TELEFONE VALUES(NULL,'COM','3123-4212',2);
INSERT INTO TELEFONE VALUES(NULL,'CEL','3323-4212',3);
INSERT INTO TELEFONE VALUES(NULL,'RES','3923-4212',3);
INSERT INTO TELEFONE VALUES(NULL,'RES','9887-4212',5);
INSERT INTO TELEFONE VALUES(NULL,'CEL','4992-4212',5);
INSERT INTO TELEFONE VALUES(NULL,'CEL','8872-4212',2);

/* SELEÇÃO , PROJEÇÃO E JUNÇÃO */

/* PROJEÇÃO -> TUDO QUE VOCÊ QUE VER NA TELA */

 /* SELECAO  É UM SUBCONJUNTO  DO CONJUNTO TOTAL DE REGISTROS DE UMA 
 TABELA A CLAUSULA DE SELEÇÃO É O WHERE
 */
...
| ANA    | ANINHA@IG.COM |         3 |
| CLARA  | CLARA@IG.COM  |         4 |
| JORGE  | JORGE@IG.COM  |         5 |
| CELIA  | CELIA@IG.COM  |         6 |
| MAGNO  | MAGNO@IG.COM  |         7 |
+--------+---------------+-----------+
...
|          3 | BAIXADA SANTISTA     | SANTOS         |
|          4 | CURUÇA               | SÃO PAULO      |
|          5 | CANAASVIEIRAS        | FLOARIANOPOLIS |
|          6 | JURERE INTERNACIONAL | PENHA          |
+------------+----------------------+----------------+
...
+--------+------+----------------------+----------------+
| JOÃO   | M    | CENTRO               | BELO HORIZONTE |
| CARLOS | M    | FLAMENGO             | RIO DE JANEIRO |
| ANA    | F    | BAIXADA SANTISTA     | SANTOS         |
| CLARA  | F    | CURUÇA               | SÃO PAULO      |
| JORGE  | M    | CANAASVIEIRAS        | FLOARIANOPOLIS |
| CELIA  | F    | JURERE INTERNACIONAL | PENHA          |
+--------+------+----------------------+----------------+
...
| NOME   | SEXO | BAIRRO           | CIDADE         | TIPO | NUMERO    |
+--------+------+------------------+----------------+------+-----------+
| JOÃO   | M    | CENTRO           | BELO HORIZONTE | CEL  | 4323-4212 |
| JOÃO   | M    | CENTRO           | BELO HORIZONTE | COM  | 5323-4212 |
| CARLOS | M    | FLAMENGO         | RIO DE JANEIRO | RES  | 6423-4212 |
| CARLOS | M    | FLAMENGO         | RIO DE JANEIRO | COM  | 3123-4212 |
| CARLOS | M    | FLAMENGO         | RIO DE JANEIRO | CEL  | 8872-4212 |
| ANA    | F    | BAIXADA SANTISTA | SANTOS         | CEL  | 3323-4212 |
| ANA    | F    | BAIXADA SANTISTA | SANTOS         | RES  | 3923-4212 |
| JORGE  | M    | CANAASVIEIRAS    | FLOARIANOPOLIS | RES  | 9887-4212 |
| JORGE  | M    | CANAASVIEIRAS    | FLOARIANOPOLIS | CEL  | 4992-4212 |
+--------+------+------------------+----------------+------+-----------+
...
INSERT INTO CLIENTE VALUES(NULL,'PAULA','M',NULL,'774023311')
INSERT INTO ENDERECO VALUES (NULL,'RUA JOÃO SILVA','PRAIA','BUZIOS','RJ',8);
...
/*UPDATE  SEMPRE ULTILIZAR COM A CLAUSULA WHERE*/ 
...
SELECT C.NOME , C.SEXO , C.EMAIL, C.CPF , E.RUA , E.BAIRRO , E.CIDADE,
...
/* IDS E EMAIL DAS MULHERES QUE MOREM NO CENTRO DO RIO DE JANEIRO
 E NÃO TENHAM CELULAR */
 
/* DEIXAR O OR DENTRO DE PARENTESIS */
...
SELECT C.NOME,  IFNULL(C.EMAIL, 'NÃO TEM EMAIL') AS 'E-MAIL'
	  ,E.ESTADO , T.NUMERO 
FROM CLIENTE C
INNER JOIN ENDERECO E
ON C.IDCLIENTE = E.ID_CLIENTE
...
SELECT NOME, NUMERO , ESTADO FROM RELATORIO;

SELECT C.IDCLIENTE, C.NOME, E.RUA , T.NUMERO
FROM CLIENTE C
INNER JOIN ENDERECO E
ON C.IDCLIENTE = E.ID_CLIENTE
INNER JOIN TELEFONE T
...
SELECT NOME, RUA , NUMERO FROM RELATORIO;
...
SELECT * FROM ALUNOS 
ORDER BY 2;
/* É PERMITIDO FAZER UPDATE EM VIEWS COM JOINS , MAS NÃO PODE
DELETAR E FAZER INSERT */
...
/* MUDANDO O DELIMITADOR TEM QUE TER ESPAÇO SE COLOCAR TUDO 
JUNTO NÃO MUDA E APENAS UM ESPAÇO*/
DELIMITER $
...
/* NUNCA USE APENAS PARA FINS ACADEMICOS */
SELECT * FROM CURSOS;

/* o que separa o numero flutuante é o ponto não a virgula */


-- BANCO DE DADOS ORACLE 11G 

SEGMENTOS SÃO OS OBJETOS DOS BANCO DE DADOS ORACLE 
TABLEAS  - INDICES  - VIEWS - PROCEDURES 
DATABLOCKS - UNIDADE MINIMA DE ARMAZENAMENTO
OLTP - INSERT , DEELETE , UPDATE 
OLAP - SELECT 
EXTENTS - O CONJUNTO DE DATABLOKS
DATAFLIES - ESTRUTURAS FISICAS DE ARMAZENAMENTO DO BANCO DE DADOS 
ORACLE . OS DATAFILES COMPÔEM AS TABLESPACES E A SOMA DOS SEUS TAMANHOS
É O TOTAL DE TAMANHO DE TABLESPACE
TABLESPACE - PERMANENTE DICIONARIO DE DADOS , DADOS DE APLICAÇÕES E
TEMPORARIA DADOS TEMPORARIOS 
CONTROLFILE RESPONSAVEL PELO CONTROLE DE FUNCIONAMENTO DA BASE DE DADOS
COMMIT GRAVAR OS DADOS*/


/* Como os redolog funcionam de maneira circular , os dados são sobrescritos em 
determinado momento. Para evitar perdade de dados, podemos colocar o banco de
dados em modo Archive , onde um arquivo é gerado com a cópia dos redo a cada 
mudança de arquivo. O arquivo de Archive não é obrigatório no Oracle, porém é 
amplamente utilizado em ambiente de produção */

/* SPFILE É BINÁRIO E É LIDO */
/*PFILE É UM ARQUIVO DE TEXTO ELE PODE SER DIGITADO */

/* PASSWORDFILE ARQUIVOS DE SENHAS CRIPTOGRADAS PARA AUTENTICAÇÃO NO BANCO 
DE DADOS */

/* ARQUIVOS DE BACKUPS - GERALMENTE COMPOSTOS DE DBFS , CONTROLFILES , 
ARCHIVELOGS E O ARQUIVOS DE INICIALIZAÇÃO */

/* ARQUIVOS DE LOG - SÃO OS ARQUIVOS TRACE , OU .TRC , QUE SERVEM PARA MONITORAR
O BANCO DE DADOS */

/* ARQUIVOS DE ALERTA - ALERT LOGS , ARQUIVOS DE LAERTA AUTOMÁTICOS DE TODAS 
AS SITUAÇÕES QUE OCORREM NO BANCO DE DADOS */

/* SGA - MEMORIA COMPARTILHADA
SHARED POOL - VERIFICA SE O COMANDO ESTÁ CORRETO
DATABASE BUFFER CACHE - ARMAZENA OS DADOS COMITADOS PELO USUÁRIO
JAVA POOL - ARMAZENA CÓDIGOS JAVA E JVM*/

/* PGA - CADA USUARIO TEM A SUA MEMORIA */

/* PROCESSOS 

PMON - RESPONSABEL POR MONITORAR TODOS OS OUTROS , QUANDO UM PROCESSO TERMINA 
IRREGULARMENTE , É O PMON QUE LIBERA OS DADOS LOCK E RECUPERA ESSE PROCESSO

SMON TAREFA DIVERSAS , MAS COMO PRINCIPAL , A RECUPERAÇÃO AUTOMÁTICA DA 
INSTANCIA NO STARTUP 

DBWRITERN - GRAVA CONTEUDOS DOS DATABASE BUFFER CACHE 

RECO - RECUPERA OU FINALIZA FALHAS DE TRANSAÇÕES . SOMENTE BASES DE DADOS 
DISTRIBUIDOS 

LGWR - TEM QUE FAZER COMMIT PARA UMA NOVA APLICAÇÃO 
*/

/* CRIANDO O BANCO DE DADOS ORACLE */

-- USUARIO DO BANCO DE DADOS 
SHOW USER;

-- TABELA DUMMY 
/* TUDO DO ORACLE TEM QUE VIM DE UMA TABELA */

SELECT 1 + 1 AS SOMA FROM DUAL; -- FAZER DESSA FORMA
...
-- DICIONARIO DE DADOS 
-- CONSULTANDO O DICIONARIO DE DADOS 
...
-- VERIFICAR PRIVILEGIOS DOS USUARIO
...
/* ARMAZENAMENTO 
LOGICO - TABLESPACES -> SEGMENTOS(OBJETOS) -> EXTENSOES (ESPAÇO) -> BLOCOS
...
/* TODO OBJETO É CRIADO POR PADRÃO NA TABLESPACE USERS
...
/* SEQUENCE É PARECIDO COM AUTO_INCREMENT DO MYSQL E
INTITY DO SQL SERVER */ 
...
--MOSTRA ONDE ESTÁ O ÚLTIMO ERRO
SHOW ERRORS;

INSERT INTO ALUNO VALUES(SEQ_EXEMPLO.NEXTVAL,'MAFRA','MAFRA@GMAIL.COM',100.00);

/* MOSTRANDO AS TRIGGERS QUE TEM NO BANCO E SEU CÓDIGO PARA SER REUTILIZADO */
SELECT TRIGGER_NAME AS NOME , TRIGGER_BODY AS CODIGO
FROM USER_TRIGGERS;
...
-- IMPEDE A INSERÇÃO PORQUE É SOMENTE LEITURA
...
-- FORCE CRIADA COM ERRO DE COMPILAÇÃO
...
INSERT INTO TELEFONE VALUES (1,'34533355',1007);

SELECT * FROM RELATORIO;

-- DEFARRABLE CONSTRAINTS 
...
INSERT INTO FUNCIONARIO VALUES(2,'MARIO');
INSERT INTO TELEFONE VALUES(11,'33447766',2);

SELECT * FROM TELEFONE;
SELECT * FROM FUNCIONARIO;

/* A CONSTRAINT DE INTEGRIDADE REFERENCIAL CHECA A 
INTEGRIDADE APÓS O COMANDO DE DML INSERT DELETE E UPDATE - 
NÃO POSSIBILITANDO ASSIM A INSERÇÃO DE REGISTROS SEM 
REFERÊNCIA */
...
SELECT CONSTRAINT_NAME , DEFERRABLE AS ATRASADA , 
DEFERRED AS VERIFICACAO
FROM USER_CONSTRAINTS  
WHERE TABLE_NAME IN('FUNCIONARIO','TELEFONE');


INSERT INTO TELEFONE VALUES(4,'44558811',10);
...
-- FAZ COMMIT DE QUEM NÃO ESTÁ COM INTEGRIDADE 
COMMIT;
...
select p.name, pr.name, pr.id_categories FROM providers p
...
select avg(price), format(price 2,2) as 'price'
from products

select avg(round(price,2)) from products

SELECT ROUND(avg(convert(float,  price)) * 100, 2) 
from products
...
inner join categories c
on c.id = p.id_categories
where pr.name LIKE '%Sansul SA%' and 
...
where 
p.amount > 100 and 
p.id_categories in(1,2,3,6 or 9) 
order by p.id_categories asc;

select count(distinct city) from customers;

SELECT SUBSTRING(cpf,1,3) FROM natural_person where LEN(documento) = 11
